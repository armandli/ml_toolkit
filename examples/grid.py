...
#reinforcement learning using a grid world of 2 dimentions, but we add a new dimension
#to represent each different type of object in the world: person, wall, pit, goal
...
#just show an example output; read outputs left to right: up/down/left/right

#reinforcement learning, without memory replay
epochs = 1000
